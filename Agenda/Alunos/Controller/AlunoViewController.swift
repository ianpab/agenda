...
class AlunoViewController: UIViewController, ImagePickerFotoSelecionada {
    ...
    func montarDicionario() -> Dictionary<String, String>{
    ...
    @IBAction func botaoCompartilhar(_ sender: UIButton) {
        ...
        let activityViewController = UIActivityViewController(activityItems: [nome, nota, imagem], applicationActivities: nil)
